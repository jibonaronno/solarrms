		...
		<div style="width:650px; float:left">
			<table border="1"  style="width:100%; border-collapse:collapse">
						...
						{										
											...
											if($i>3){$c_1=((int)$cvoltage[$i]);$c_2=((int)$cvoltage[$i-1]);$c_3=((int)$ccvoltage[$i-2]);}
											...
											if((($a_1==$a_2)&&($a_1==$a_3))&&(($b_1==$b_2)&&($b_1==$b_3))&&(($c_1==$c_2)&&($c_1==$c_3)))
												{$avoltagetemp=0;$bvoltagetemp=0;$cvoltagetemp=0;$acurrenttemp=0;$acurrenttemp=0;$acurrenttemp=0;}
