...
//print_r($_GET); exit;
 ...
 //$insert = mysql_query($sql);
  $sql	=	"UPDATE `bts_status` SET `bts_id` = '$bts_id',`door` = '$door',`generator` = '$generator',`main` = '$main',`aviation` = '$aviation',`esc` = '$esc',`others` = '$others',`create_date` = NOW( ) WHERE bts_id ='". $bts_id. "'";
