		...
		<div style="width:650px; float:left">
			<table border="1"  style="width:100%; border-collapse:collapse">
						...
						{										
											...
											?>
											<?php 
											$activepower1= number_format(floatval(((int)$bvoltage[$i]/10)-1), 1)*number_format(floatval(((int)$bcurrent[$i]/1000)-2), 2);
											...
											<td><?php $formattedNum = number_format(floatval(((int)$bvoltage[$i]/10)-1), 1);echo $formattedNum;?></td>													
											<td><?php $formattedNum = number_format(floatval(((int)$bcurrent[$i]/1000)-2), 2);echo $formattedNum;?></td>													
