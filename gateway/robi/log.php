		...
		<div style="width:650px; float:left">
			<table border="1"  style="width:100%; border-collapse:collapse">
						...
						{										
											...
											<td><?php $formattedNum = number_format(floatval((int)$pv1volt[$i]/10), 1);echo $formattedNum;?></td>													
											<td><?php $formattedNum = number_format(floatval((int)$pv2volt[$i]/10), 1);echo $formattedNum; ?></td>													
											<td><?php $formattedNum = number_format(floatval((int)$actpower[$i]/10), 1);echo $formattedNum;?></td>													
											<td><?php $formattedNum = number_format(floatval((int)$avoltage[$i]/10), 1);echo $formattedNum;?></td>													
											<td><?php $formattedNum = number_format(floatval((int)$acurrent[$i]/1000), 2);echo $formattedNum;?></td>													
